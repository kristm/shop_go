...
func TestMarshalOrder(t *testing.T) {
	...
	expect := "{\"id\":0,\"shipping_id\":0,\"customer_id\":1,\"reference_code\":\"\",\"payment_reference\":\"\",\"amount_in_cents\":0,\"status\":0,\"voucher\":\"\",\"orders\":[{\"id\":0,\"order_id\":0,\"product_id\":2,\"name\":\"\",\"qty\":1,\"price\":200},{\"id\":0,\"order_id\":0,\"product_id\":3,\"name\":\"\",\"qty\":2,\"price\":250.5}],\"amount\":701}"
